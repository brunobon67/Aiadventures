                    ...
                    {isExpanded && (
                        <div className="mt-4 text-sm text-yellow-800 space-y-4 animate-fade-in">
                            ...
                            <div>
                                ...
                                <p>Copy your web app's <code className="bg-yellow-100 p-1 rounded text-xs">firebaseConfig</code> object and paste it into the <code className="bg-yellow-100 p-1 rounded text-xs">services/geminiService.ts</code> file, replacing the placeholder values.</p>
