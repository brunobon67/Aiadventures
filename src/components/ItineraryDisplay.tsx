...
import { ArrowPathIcon, BookmarkIcon, CalendarIcon, CheckIcon, FoodIcon, LandmarkIcon, LeafIcon, LightbulbIcon, MapPinIcon, PrintIcon, ShoppingBagIcon, SunIcon, TransitIcon, UnknownIcon } from './icons';
...
const ItineraryDisplay: React.FC<ItineraryDisplayProps> = ({ itinerary, onSave, onReset, isFirebaseConfigured }) => {
  ...
  return (
    <div className="bg-white p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-200/50 space-y-6 printable-area animate-fade-in">
